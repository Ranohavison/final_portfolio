  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Next.js", level: 92, color: "from-gray-800 to-gray-600" },
        { name: "TypeScript", level: 90, color: "from-blue-600 to-blue-400" },
        { name: "Tailwind CSS", level: 88, color: "from-teal-500 to-cyan-400" },
        { name: "Vue.js", level: 75, color: "from-green-500 to-emerald-400" },
      ]
    },
    {
      title: "Backend",
      ...
      skills: [
        ...
        { name: "Express.js", level: 87, color: "from-gray-700 to-gray-500" },
      ]
    },
    {
      title: "DevOps & Cloud",
      ...
      skills: [
        ...
        { name: "Docker", level: 80, color: "from-blue-600 to-blue-400" },
